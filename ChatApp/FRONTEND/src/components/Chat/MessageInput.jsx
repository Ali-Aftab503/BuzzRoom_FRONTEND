      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1">
          <input
            ...
            disabled={disabled}
            className="w-full bg-zinc-800 border border-zinc-700 text-zinc-100 placeholder-zinc-500 px-4 py-3 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
